...
public class XmlTxParser
{
    private static final Logger LOGGER = LoggerFactory.getLogger(XmlParser.class);

    private static final String CLAZZ_TAG = "/metalib/struct";
    private static final String PROPERTY_TAG = "entry";
    
    private Document doc;
    private String clazzTag;
    private String propertyTag;

    public XmlTxParser(String path)
    {
        ...
        {
            LOGGER.error("parse tx xml error. {}", path, e);
        }
    ...
    private Clazz genClazz(Element element)
    {
        ...
        String parentClassName = element.attributeValue("table");
        parentClassName = convertUpperName(parentClassName);
        parentClassName = replaceUnderline(parentClassName);
        
        Clazz clazz = new Clazz(clazzName, clazzDesc);
        clazz.setParentClassName(parentClassName);
        ...
        for (Element temp : temps)
        {
            if (temp.getName().equals(propertyTag))
            {
                ...
                String columnName = temp.attributeValue("column");
                ...
                String upperColumnName = convertUpperName(columnName);
                property.setUpperColumnName(upperColumnName);
